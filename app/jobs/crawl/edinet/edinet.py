...
from app.core.urls import DOCUMENTS_LIST_URL, get_document_url


# API interaction functions
def fetch_documents_list(date: str | datetime.date,
                         type: int = 2) -> dict:
...
def get_documents_for_date_range(start_date: datetime.date,
                                 ...
                                 edinet_codes=None,
                                 doc_type_codes=None,
                                 excluded_doc_type_codes: list[str] = None,
                                 require_sec_code: bool = True) -> list[dict]:
